...
The error report is automatically generated via continuous integration. The following results were generated on an AMD Ryzen 5 4600H with Radeon Graphics @4.0 GHz, 16 GB of RAM, running x86_64-unknown-linux-gnu rustc 1.90.0 and magba v0.6.0 at 64-bit precision. The performance is benchmarked using Criterion, and the compute times are divided by the number of test cases (1,000) to obtain the approximate time to compute the field function for an observer point.

Table 1: Summary of Field Function Accuracy at 64-bit Precision.

+-----------------------+-----------------------+-----------------------+-----------------------+-----------------------+-----------------------+
| **Function**          | **Median**            | **Mean**              | **P95**               | **Max**               | **Performance**       |
+:======================+:======================+:======================+:======================+:======================+:======================+
| CircularCurrent       | $0.000$               | $1.137\times10^{-11}$ | $1.320\times10^{-10}$ | $1.321\times10^{-10}$ | 41.8 ns               |
+-----------------------+-----------------------+-----------------------+-----------------------+-----------------------+-----------------------+
| PathCurrent           | $1.320\times10^{-10}$ | $1.182\times10^{-10}$ | $1.320\times10^{-10}$ | $1.320\times10^{-10}$ | 45.0 ns               |
+-----------------------+-----------------------+-----------------------+-----------------------+-----------------------+-----------------------+
| SheetCurrent          | $0.000$               | $5.287\times10^{-13}$ | $0.000$               | $1.320\times10^{-10}$ | 146.9 ns              |
+-----------------------+-----------------------+-----------------------+-----------------------+-----------------------+-----------------------+
| TriangleCurrent       | $0.000$               | $0.000$               | $0.000$               | $0.000$               | 59.3 ns               |
+-----------------------+-----------------------+-----------------------+-----------------------+-----------------------+-----------------------+
| CylinderMagnet        | $2.947\times10^{-13}$ | $3.511\times10^{-12}$ | $2.543\times10^{-12}$ | $2.501\times10^{-10}$ | 59.5 ns               |
+-----------------------+-----------------------+-----------------------+-----------------------+-----------------------+-----------------------+
| CuboidMagnet          | $0.000$               | $6.930\times10^{-15}$ | $5.568\times10^{-14}$ | $2.103\times10^{-13}$ | 117.9 ns              |
+-----------------------+-----------------------+-----------------------+-----------------------+-----------------------+-----------------------+
| Dipole                | $1.320\times10^{-10}$ | $7.586\times10^{-11}$ | $1.320\times10^{-10}$ | $1.320\times10^{-10}$ | 14.4 ns               |
+-----------------------+-----------------------+-----------------------+-----------------------+-----------------------+-----------------------+
| SphereMagnet          | $0.000$               | $8.086\times10^{-19}$ | $0.000$               | $8.078\times10^{-16}$ | 26.8 ns               |
+-----------------------+-----------------------+-----------------------+-----------------------+-----------------------+-----------------------+
| TetrahedronMagnet     | $0.000$               | $3.450\times10^{-13}$ | $7.618\times10^{-13}$ | $1.020\times10^{-10}$ | 92.9 ns               |
+-----------------------+-----------------------+-----------------------+-----------------------+-----------------------+-----------------------+
| TriangleMagnet        | $0.000$               | $1.066\times10^{-14}$ | $3.274\times10^{-14}$ | $2.405\times10^{-12}$ | 48.5 ns               |
+-----------------------+-----------------------+-----------------------+-----------------------+-----------------------+-----------------------+
| MeshMagnet            | $0.000$               | $3.450\times10^{-13}$ | $7.618\times10^{-13}$ | $1.020\times10^{-10}$ | 95.4 ns               |
+-----------------------+-----------------------+-----------------------+-----------------------+-----------------------+-----------------------+
